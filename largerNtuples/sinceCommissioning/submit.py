...
config = config()
config.General.requestName = 'CICADA_Commissioning_allRuns_16July2024'
...
config.Data.runRange = '382725-383247'
config.Data.publication = False
config.Data.outputDatasetTag = 'CICADA_Commissioning_allRuns_16July2024'
