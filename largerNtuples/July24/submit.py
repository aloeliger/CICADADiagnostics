...
config = config()
config.General.requestName = 'CICADA_Commissioning_July24Runs_25July2024'
...
config.Data.runRange = '383524-383615'
config.Data.publication = False
config.Data.outputDatasetTag = 'CICADA_Commissioning_July24Runs_25July2024'
